...
export class InitialMigration1710888995050 implements MigrationInterface {
    name = 'InitialMigration1710888995050'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "books" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "type" character varying(6) NOT NULL, "price" integer NOT NULL, "userId" integer, CONSTRAINT "PK_f3f2f25a099d24e12545b70b022" PRIMARY KEY ("id"))`);
