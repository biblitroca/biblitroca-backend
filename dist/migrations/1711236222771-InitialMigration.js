...
class InitialMigration1711236222771 {
    ...
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`CREATE TABLE "books" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "author" character varying(50) NOT NULL, "type" character varying(7) NOT NULL, "price" integer NOT NULL, "userId" integer, CONSTRAINT "PK_f3f2f25a099d24e12545b70b022" PRIMARY KEY ("id"))`);
